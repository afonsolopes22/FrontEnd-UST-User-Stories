  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[200px] gap-8">
      <div className="relative w-20 h-20 flex items-center justify-center">
        ...
        {/* Main Arc */}
        <div className="absolute inset-1 rounded-full border-2 border-transparent border-t-primary shadow-[0_0_6px_rgba(82,54,171,0.5)] animate-[spin_2s_linear_infinite]" />

        {/* Reverse Arc */}
        <div className="absolute inset-3 rounded-full border-2 border-transparent border-b-primary/70 shadow-[0_0_6px_rgba(82,54,171,0.4)] animate-[spin_3s_linear_infinite_reverse]" />
        ...
        <div className="absolute inset-0 animate-[spin_4s_linear_infinite]">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full bg-primary shadow-[0_0_4px_rgba(82,54,171,0.9)]" />
        </div>

        {/* Center Core */}
        <div className="absolute w-2 h-2 rounded-full animate-pulse bg-primary shadow-[0_0_6px_rgba(82,54,171,0.6)]" />
      </div>
